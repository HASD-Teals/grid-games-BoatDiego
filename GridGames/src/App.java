...
public class App {
    ...
    public static String[] WizChar() {
        ...
        System.out.println("Hello " + Traits[1] + " What robes do you wish to wear?");
        boolean ans = true;
        while (ans == true) {
            System.out.println("Note: It must be a one letter char");
            Traits[2] = input.nextLine();
            if (Traits[2].length() != 1) {
    ...
    public static char[][] Wizardgame() {
        // formulate code with various function
        char[][] game;
